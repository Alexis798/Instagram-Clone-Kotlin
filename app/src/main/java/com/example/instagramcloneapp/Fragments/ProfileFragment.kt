...
class ProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (pref != null) {
            /**OJO       esto puede ser lo que esta causando el lag al cargar           **/
            this.profileId = pref.getString("profileId", "none") ?: "default"
        }
        ...
        val edit = view.findViewById<Button>(R.id.edit_account_settings_btn)

        //Here we notify our screen that when we press the button our activity will change to the current context to the Account Settings
    ...
    private fun userInfo() {
        ...
        val usersRef = FirebaseDatabase.getInstance().getReference().child("Users").child(profileId.toString())
