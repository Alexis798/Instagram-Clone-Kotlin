...
class AddPostActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val saveNewPostButton = findViewById<ImageView>(R.id.save_new_post_btn)
    ...
    private fun uploadImage() {
        ...
        when {
            ...
            TextUtils.isEmpty(findViewById<EditText>(R.id.description_post).text.toString()) -> Toast.makeText(this, "Please write a description first", Toast.LENGTH_LONG).show()
